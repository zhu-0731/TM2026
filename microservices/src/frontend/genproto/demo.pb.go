...
type OrderResult struct {
	...
	CouponDiscount     *Money       `protobuf:"bytes,7,opt,name=coupon_discount,json=couponDiscount,proto3" json:"coupon_discount,omitempty"`
}
...
func (x *OrderResult) GetCouponDiscount() *Money {
	if x != nil {
